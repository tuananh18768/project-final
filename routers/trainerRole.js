...
router.put(
    ...
    auth,
    authTrainer,
    trainerController.updateTutorial
);
...
router.get(
    ...
    auth,
    authTrainer,
    trainerController.getAllTutorial
);
...
router.delete(
    ...
    auth,
    authTrainer,
    trainerController.deleteTutorial
);
...
router.put(
    ...
    auth,
    authTrainer,
    trainerController.updateCourses
);
...
router.delete(
    ...
    auth,
    authTrainer,
    trainerController.deleteCourses
);
...
router.get(
    ...
    auth,
    authTrainer,
    trainerController.getAllCoursesTutorial
);
...
router.get(
    ...
    auth,
    authTrainer,
    trainerController.getAllCourses
);

router.get("/dashboard", auth, authTrainer, trainerController.dashboard);
